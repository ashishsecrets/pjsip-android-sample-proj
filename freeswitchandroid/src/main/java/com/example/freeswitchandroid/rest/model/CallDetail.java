...
public class CallDetail {
    ...
    public Boolean getRejectedCall() {
        return isRejectedCall;
    }

    public void setRejectedCall(Boolean rejectedCall) {
        isRejectedCall = rejectedCall;
    }
